...
export type CreateDailyPracticeAttemptDTO = {
    points: Array<(string)>;
};
...
export type DailyPracticeAttemptBaseDTO = {
    daily_practice: DailyPracticeDTO;
};

export type DailyPracticeAttemptDTO = {
    daily_practice: DailyPracticeDTO;
    comments: Array<CommentDTO>;
    points: Array<DailyPracticeAttemptPointDTO>;
};

export type DailyPracticeAttemptPointDTO = {
    content: string;
};
...
export type GetAllDailyPracticesDailyPracticesGetData = unknown;

export type GetAllDailyPracticesDailyPracticesGetResponse = (Array<DailyPracticeDTO>);

export type GetAllDailyPracticesDailyPracticesGetError = (HTTPValidationError);

export type GetTodaysPracticeDailyPracticesTodayGetData = unknown;
...
export type CreateDailyPracticeAttemptDailyPracticesIdAttemptsPostResponse = (number);

export type CreateDailyPracticeAttemptDailyPracticesIdAttemptsPostError = (HTTPValidationError);

export type GetAllAttemptsDailyPracticesAttemptsGetData = unknown;

export type GetAllAttemptsDailyPracticesAttemptsGetResponse = (Array<DailyPracticeAttemptBaseDTO>);

export type GetAllAttemptsDailyPracticesAttemptsGetError = (HTTPValidationError);

export type GetAttemptDailyPracticesAttemptsIdGetData = {
    path: {
        id: number;
    };
};

export type GetAttemptDailyPracticesAttemptsIdGetResponse = (Array<DailyPracticeAttemptDTO>);

export type GetAttemptDailyPracticesAttemptsIdGetError = (HTTPValidationError);