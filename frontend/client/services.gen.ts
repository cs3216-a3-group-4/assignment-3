 ...
 */
export const completeEmailVerificationAuthVerifyEmailPut = <ThrowOnError extends boolean = false>(options: Options<CompleteEmailVerificationAuthVerifyEmailPutData, ThrowOnError>) => { return (options?.client ?? client).put<CompleteEmailVerificationAuthVerifyEmailPutResponse, CompleteEmailVerificationAuthVerifyEmailPutError, ThrowOnError>({
    ...options,
