 ...
 */
export const getAllDailyPracticesDailyPracticesGet = <ThrowOnError extends boolean = false>(options?: Options<GetAllDailyPracticesDailyPracticesGetData, ThrowOnError>) => { return (options?.client ?? client).get<GetAllDailyPracticesDailyPracticesGetResponse, GetAllDailyPracticesDailyPracticesGetError, ThrowOnError>({
    ...options,
    url: '/daily-practices/'
}); };
 ...
 * Get Todays Practice
 */
export const getTodaysPracticeDailyPracticesTodayGet = <ThrowOnError extends boolean = false>(options?: Options<GetTodaysPracticeDailyPracticesTodayGetData, ThrowOnError>) => { return (options?.client ?? client).get<GetTodaysPracticeDailyPracticesTodayGetResponse, GetTodaysPracticeDailyPracticesTodayGetError, ThrowOnError>({
    ...options,
    url: '/daily-practices/today'
}); };
...
/**
 * Create Daily Practice Attempt
 */
export const createDailyPracticeAttemptDailyPracticesIdAttemptsPost = <ThrowOnError extends boolean = false>(options: Options<CreateDailyPracticeAttemptDailyPracticesIdAttemptsPostData, ThrowOnError>) => { return (options?.client ?? client).post<CreateDailyPracticeAttemptDailyPracticesIdAttemptsPostResponse, CreateDailyPracticeAttemptDailyPracticesIdAttemptsPostError, ThrowOnError>({
    ...options,
    url: '/daily-practices/{id}/attempts'
}); };

/**
 * Get All Attempts
 */
export const getAllAttemptsDailyPracticesAttemptsGet = <ThrowOnError extends boolean = false>(options?: Options<GetAllAttemptsDailyPracticesAttemptsGetData, ThrowOnError>) => { return (options?.client ?? client).get<GetAllAttemptsDailyPracticesAttemptsGetResponse, GetAllAttemptsDailyPracticesAttemptsGetError, ThrowOnError>({
    ...options,
    url: '/daily-practices/attempts'
}); };

/**
 * Get Attempt
 */
export const getAttemptDailyPracticesAttemptsIdGet = <ThrowOnError extends boolean = false>(options: Options<GetAttemptDailyPracticesAttemptsIdGetData, ThrowOnError>) => { return (options?.client ?? client).get<GetAttemptDailyPracticesAttemptsIdGetResponse, GetAttemptDailyPracticesAttemptsIdGetError, ThrowOnError>({
    ...options,
    url: '/daily-practices/attempts/{id}'
}); };