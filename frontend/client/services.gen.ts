 ...
 * Ask Gp Question
 */
export const askGpQuestionUserQuestionsAskGpQuestionGet = <ThrowOnError extends boolean = false>(options: Options<AskGpQuestionUserQuestionsAskGpQuestionGetData, ThrowOnError>) => { return (options?.client ?? client).get<AskGpQuestionUserQuestionsAskGpQuestionGetResponse, AskGpQuestionUserQuestionsAskGpQuestionGetError, ThrowOnError>({
    ...options,
 ...
 * Gen Points
 */
export const genPointsUserQuestionsGenPointsGet = <ThrowOnError extends boolean = false>(options: Options<GenPointsUserQuestionsGenPointsGetData, ThrowOnError>) => { return (options?.client ?? client).get<GenPointsUserQuestionsGenPointsGetResponse, GenPointsUserQuestionsGenPointsGetError, ThrowOnError>({
    ...options,
    url: '/user-questions/gen-points'
}); };
