...
import type {
  ...
  CompleteEmailVerificationAuthEmailVerificationPutError,
  CompleteEmailVerificationAuthEmailVerificationPutResponse,
  ...
  CreateCheckoutSessionBillingCreateCheckoutSessionPostData,
  CreateCheckoutSessionBillingCreateCheckoutSessionPostError,
  CreateCheckoutSessionBillingCreateCheckoutSessionPostResponse,
  CreateConceptBasedUserQnUserQuestionsPostData,
  CreateConceptBasedUserQnUserQuestionsPostError,
  CreateConceptBasedUserQnUserQuestionsPostResponse,
  ...
  CreatePointUserQuestionsIdPointsPostData,
  CreatePointUserQuestionsIdPointsPostError,
  CreatePointUserQuestionsIdPointsPostResponse,
  ...
  DeleteEssayEssaysIdDeleteData,
  DeleteEssayEssaysIdDeleteError,
  ...
  DowngradeSubscriptionBillingDowngradeSubscriptionPutResponse,
  ...
  GetSubscriptionStatusSubscriptionsIdStatusGetData,
  GetSubscriptionStatusSubscriptionsIdStatusGetError,
  GetSubscriptionStatusSubscriptionsIdStatusGetResponse,
  GetSubscriptionSubscriptionsIdGetData,
  GetSubscriptionSubscriptionsIdGetError,
  GetSubscriptionSubscriptionsIdGetResponse,
  ...
  RegenerateExamplesUserQuestionsPointIdExamplesPutData,
  RegenerateExamplesUserQuestionsPointIdExamplesPutError,
  RegenerateExamplesUserQuestionsPointIdExamplesPutResponse,
  ...
  StripeWebhookBillingWebhookPostData,
  StripeWebhookBillingWebhookPostError,
  StripeWebhookBillingWebhookPostResponse,
 ...
 * Stripe Webhook
 */
export const stripeWebhookBillingWebhookPost = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<StripeWebhookBillingWebhookPostData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    StripeWebhookBillingWebhookPostResponse,
    StripeWebhookBillingWebhookPostError,
 ...
 */
export const completeEmailVerificationAuthEmailVerificationPut = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    CompleteEmailVerificationAuthEmailVerificationPutData,
 ...
 */
export const resendVerificationEmailAuthEmailVerificationPost = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<
    ResendVerificationEmailAuthEmailVerificationPostData,
 ...
 */
export const createCheckoutSessionBillingCreateCheckoutSessionPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    CreateCheckoutSessionBillingCreateCheckoutSessionPostData,
 ...
 */
export const downgradeSubscriptionBillingDowngradeSubscriptionPut = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<
    DowngradeSubscriptionBillingDowngradeSubscriptionPutData,
 ...
 */
export const createConceptBasedUserQnUserQuestionsPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<CreateConceptBasedUserQnUserQuestionsPostData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    CreateConceptBasedUserQnUserQuestionsPostResponse,
    CreateConceptBasedUserQnUserQuestionsPostError,
 ...
 * Create Point
 */
export const createPointUserQuestionsIdPointsPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<CreatePointUserQuestionsIdPointsPostData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    CreatePointUserQuestionsIdPointsPostResponse,
    CreatePointUserQuestionsIdPointsPostError,
 ...
 * Regenerate Examples
 */
export const regenerateExamplesUserQuestionsPointIdExamplesPut = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    RegenerateExamplesUserQuestionsPointIdExamplesPutData,
 ...
 * Delete Essay
 */
export const deleteEssayEssaysIdDelete = <ThrowOnError extends boolean = false>(
  options: Options<DeleteEssayEssaysIdDeleteData, ThrowOnError>,
) => {
  return (options?.client ?? client).delete<
    DeleteEssayEssaysIdDeleteResponse,
    DeleteEssayEssaysIdDeleteError,
 ...
 * Get Subscription
 */
export const getSubscriptionSubscriptionsIdGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<GetSubscriptionSubscriptionsIdGetData, ThrowOnError>,
) => {
  return (options?.client ?? client).get<
    GetSubscriptionSubscriptionsIdGetResponse,
    GetSubscriptionSubscriptionsIdGetError,
 ...
 */
export const getSubscriptionStatusSubscriptionsIdStatusGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    GetSubscriptionStatusSubscriptionsIdStatusGetData,
