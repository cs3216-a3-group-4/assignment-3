 ...
 */
export const createUserQuestionUserQuestionsPost = <ThrowOnError extends boolean = false>(options: Options<CreateUserQuestionUserQuestionsPostData, ThrowOnError>) => { return (options?.client ?? client).post<CreateUserQuestionUserQuestionsPostResponse, CreateUserQuestionUserQuestionsPostError, ThrowOnError>({
    ...options,
    url: '/user-questions/'
}); };
...
export const getSubscriptionStatusSubscriptionsIdStatusGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<GetSubscriptionStatusSubscriptionsIdStatusGetData, ThrowOnError>,
) => {
  return (options?.client ?? client).get<
