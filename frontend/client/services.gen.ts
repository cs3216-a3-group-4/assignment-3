 ...
 * Logout
 */
export const logoutAuthLogoutGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<LogoutAuthLogoutGetResponse, LogoutAuthLogoutGetError, ThrowOnError>({
    ...options,
    url: '/auth/logout'
}); };
 ...
 * Get Categories
 */
export const getCategoriesCategoriesGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetCategoriesCategoriesGetResponse, GetCategoriesCategoriesGetError, ThrowOnError>({
    ...options,
    url: '/categories/'
}); };
