...
export const CommentArticleConceptDTOSchema = {
    properties: {
        skill_issue: {
            type: 'string',
            title: 'Skill Issue'
    ...
    type: 'object',
    required: ['skill_issue', 'article_concept'],
    title: 'CommentArticleConceptDTO'
} as const;
...
export const CommentDTOSchema = {
    properties: {
        ...
        comment_article_concepts: {
            items: {
                '$ref': '#/components/schemas/CommentArticleConceptDTO'
            },
            type: 'array',
            title: 'Comment Article Concepts'
        }
    },
    type: 'object',
    required: ['id', 'lack_example', 'inclination', 'content', 'likes', 'comment_analysises', 'comment_article_concepts'],
    title: 'CommentDTO'
} as const;
...
export const TierDTOSchema = {
    properties: {
        tier_name: {
            '$ref': '#/components/schemas/TierNames'
        },
        label: {
            type: 'string',
            title: 'Label'
        ...
        gp_question_limit: {
            type: 'integer',
            title: 'Gp Question Limit'
        }
    },
    type: 'object',
    required: ['tier_name', 'label', 'gp_question_limit'],
    title: 'TierDTO'
} as const;
...
export const UsageDTOSchema = {
    properties: {
        gp_question_asked: {
            type: 'integer',
            title: 'Gp Question Asked'
        }
    },
    type: 'object',
    required: ['gp_question_asked'],
    title: 'UsageDTO'
} as const;
...
export const src__essays__schemas__ParagraphDTO__2Schema = {
    ...
    type: 'object',
    required: ['id', 'content', 'type', 'comments'],
    title: 'ParagraphDTO'
} as const;
