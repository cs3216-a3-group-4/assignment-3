    ...
    >
      ...
      <div className="flex gap-12 items-stretch">
        <div className="flex flex-col w-full lg:w-8/12 2xl:w-9/12 3xl:w-10/12 grow">
          <h2 className="text-base md:text-lg lg:text-2xl font-semibold mt-2 mb-3 text-primary-800">
            {newsArticle.title}
          </h2>
          <p className="text-sm sm:text-base line-clamp-3 text-text">
            {newsArticle.summary}
          </p>
        </div>
      ...
      <div className="hidden sm:flex flex-wrap gap-x-2 gap-y-2 mt-6 -mx-3 place-end">
