CONCEPT_GEN_SYSPROMPT = """
    ...
    You are tasked with generating a list of insightful concepts that might be useful in discussing General Paper essays, from a given news article.
    For each concept, you should also provide more explanations about the concept.
    ...
    Your explanations must showcase this skill of conceptual understanding at a high level.
    ...
    You should not give definitions of the concepts or terms.
    ...
    Important Note: In particular, you MUST avoid the following phrases or similar ones that indicate a lack of opinion or insight:
    ...
    The summary should not start with phrases such as "The article discusses" or "The article talks about". The summary should seem as if it was generated by the news agency itself.

    You must return the list of concepts in the following JSON output format without any trailing commas or syntax errors. Here is an example:
    {
        ...
        "concepts": [
            ...
            {
                "concept": "concept3",
                "explanation": "An insightful explanation of the concept3"
            }
        ]
    }

    Final Note: Your focus MUST NOT BE ON THE CONTENT but on the CONCEPT, IDEA or THEME that the given content is portraying.
    Final Note: Your JSON output must be in the exact format as shown above. There should be no trailing commas or syntax errors.
"""
