CONCEPT_GEN_SYSPROMPT = """
    ...
    You must also generate a summary of the events in the article. This summary should cover the main events in the article. It should be concise and to the point. It should be at most 3 sentences long.
