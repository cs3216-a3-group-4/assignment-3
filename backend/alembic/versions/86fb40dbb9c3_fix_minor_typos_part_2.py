...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['article_id'], ['article.id'], name='article_concepts_article_id_fkey'),
    sa.ForeignKeyConstraint(['concept_id'], ['concept.id'], name='article_concepts_concept_id_fkey'),
    sa.PrimaryKeyConstraint('concept_id', 'article_id', name='article_concepts_pkey')
    )
