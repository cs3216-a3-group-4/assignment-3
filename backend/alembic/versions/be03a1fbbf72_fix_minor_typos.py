...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["article_id"], ["article.id"], name="article_concept_article_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["concept_id"], ["concept.id"], name="article_concept_concept_id_fkey"
        ),
        sa.PrimaryKeyConstraint(
            "concept_id", "article_id", name="article_concept_pkey"
        ),
    )
